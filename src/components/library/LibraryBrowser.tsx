        ...
        <div className="double-bezel-inner flex-1 flex flex-col overflow-hidden">
          <div className="px-8 pt-8 pb-6">
            <div className="flex items-end gap-6">
              <div className="w-40 h-40 rounded-[2rem] bg-[rgba(255,255,255,0.03)] animate-pulse flex-shrink-0" />
              <div className="flex-1 pb-2 space-y-3">
                <div className="w-16 h-3 rounded bg-[rgba(255,255,255,0.03)] animate-pulse" />
                <div className="w-48 h-10 rounded bg-[rgba(255,255,255,0.03)] animate-pulse" />
                <div className="w-28 h-4 rounded bg-[rgba(255,255,255,0.02)] animate-pulse" />
              </div>
            </div>
          </div>
  ...
  return (
    <div className="double-bezel flex-1 rounded-[calc(2rem+2px)] flex flex-col overflow-hidden animate-fade">
      <div className="double-bezel-inner flex-1 flex flex-col overflow-hidden">
        <div className="px-8 pt-8 pb-6">
          <div className="flex items-end gap-6">
            <div className="w-40 h-40 rounded-[2rem] bg-[rgba(255,255,255,0.03)] flex items-center justify-center flex-shrink-0 overflow-hidden shadow-lg ring-1 ring-white/5">
            ...
            <div className="flex-1 min-w-0 pb-2">
              <p className="text-[10px] font-semibold text-[var(--text-tertiary)] tracking-[0.2em] uppercase mb-1">Library</p>
              <h1 className="text-5xl font-extrabold text-[var(--text-primary)] tracking-tight mb-2 leading-none">
                My Music
              </h1>
        ...
        <div ref={containerRef} className="flex-1 scroll-container px-6 pb-4">
          {songs.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16">
              <div className="w-16 h-16 rounded-[2rem] bg-[rgba(255,255,255,0.03)] flex items-center justify-center mb-4">
              ...
              <button
                ...
                className="relative px-5 py-2.5 rounded-full text-[10px] font-semibold text-[var(--text-primary)] bg-[rgba(255,255,255,0.06)] hover:bg-[rgba(255,255,255,0.1)] transition-all duration-[400ms] ease-spring hover:scale-[1.02] active:scale-[0.98]"
              >
                <FiFolder size={12} className="inline mr-1.5" />
                Browse Folders
              </button>
            </div>
          ) : (
            <>
              <div className="flex items-center px-2 py-2 text-[9px] font-bold text-[var(--text-tertiary)] uppercase tracking-[0.2em] border-b border-[rgba(255,255,255,0.03)] mb-1">
